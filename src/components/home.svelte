...
<section
  class="wrapper overflow-hidden bg-background-100 w-screen h-screen pb-[80px]"
>
  ...
  <BottomNav position="fixed " navType="application" classInner="grid-cols-5">
    ...
    <div class="flex items-center justify-center">
      <BottomNavItem
        ...
        btnClass="inline-flex items-center justify-center w-10 h-10 font-medium bg-primary-600 rounded-full hover:bg-primary-300 group  focus:ring-primary-300 focus:outline-none dark:focus:ring-primary-800"
      >
        <svg
